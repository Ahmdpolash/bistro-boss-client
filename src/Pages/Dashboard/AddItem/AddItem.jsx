  ...
  return (
    <div className="">
      ...
      <div className="px-4 mt-4 lg:px-16 mx-auto max-w-6xl w-full ">
        <form className="bg-[#fff] p-6" onSubmit={handleSubmit(onSubmit)}>
          <div>
            <label htmlFor="Category Name">Recipe name*</label>
            <input
              {...register("name")}
              type="text"
          ...
          <button
            type="submit"
            className="px-6 py-3 rounded-md mt-4 flex font-semibold items-center gap-2 bg-[#B58130] text-white"
          >
